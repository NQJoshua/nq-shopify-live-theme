...
theme.Instagramm = (function() {
  ...
  function instagramm(el) {
    ...
    var feed = new Instafeed({
      ...
      template: '<a href="{{link}}" target="_blank"><img data-src="{{image}}"/><noscript><img src="{{image}}"/></noscript></a>'
    });
    feed.run();
  }
  return instagramm;
...
if ($j("#rightColumn").length > 0) {
  ...
  $j(window).trigger('resize');
	...
	function unSlickThumbs(carousel) {
      carousel.slick('unslick');
    }
	
    function reinitThumbs(carousel) {
...
$j(document).ready(function() {
  ...
  /*$j( ".spr-badge .spr-icon.spr-icon-star:nth-of-type(5)" ).replaceWith( "<i class='spr-icon spr-icon-star-half' style='color:#ffaf47;'></i>" );
  $j("<a class='review-link' href='https://www.amazon.com/gp/customer-reviews/R1CL2MKRUFFYNX/ref=cm_cr_dp_d_rvw_ttl?ie=UTF8&ASIN=B01N6PO87P' target='_blank'>Read more on Amazon</a>").insertAfter("#spr-review-10999900 .spr-review-content");
  $j("<a class='review-link' href='https://www.amazon.com/gp/customer-reviews/RARHW7CYFG6M7/ref=cm_cr_dp_d_rvw_ttl?ie=UTF8&ASIN=B01N6PO87P' target='_blank'>Read more on Amazon</a>").insertAfter("#spr-review-10999901 .spr-review-content");
  $j("<a class='review-link' href='https://www.amazon.com/gp/customer-reviews/RK7PXBPXF69MW/ref=cm_cr_dp_d_rvw_ttl?ie=UTF8&ASIN=B01N6PO87P' target='_blank'>Read more on Amazon</a>").insertAfter("#spr-review-10999902 .spr-review-content");
  $j("<a class='review-link' href='https://www.amazon.com/gp/customer-reviews/RTQVOWDETHWDN/ref=cm_cr_dp_d_rvw_ttl?ie=UTF8&ASIN=B01N6PO87P' target='_blank'>Read more on Amazon</a>").insertAfter("#spr-review-10999903 .spr-review-content");
  $j("<a class='review-link' href='https://www.amazon.com/gp/customer-reviews/R3SN10ZKO5MGGS/ref=cm_cr_dp_d_rvw_ttl?ie=UTF8&ASIN=B01N6PO87P' target='_blank'>Read more on Amazon</a>").insertAfter("#spr-review-10999904 .spr-review-content"); */
...
$j("#shopify-product-reviews").load(function() {
  //$("<a href='#'>Read more</a>").insertAfter(".spr-review-content");
  $(".spr-review-content").after("<a href='#'>Read more</a>");
});
