...
!(function (e) {
  ...
  e.JQPlugin.createPlugin({
    ...
    _resetExtraLabels: function (e, t) {
      ...
      if (i)
        for (var s in e)
          s.match(/[Ll]abels[02-9]|compactLabels1/) && (e[s] = null);
    },
    _adjustSettings: function (t, i, s) {
      ...
      if (null != a) (o = i.options.serverSync ? a : 0), (n = new Date());
        ...
        var l = e.isFunction(i.options.serverSync)
          ...
          : null;
        (n = new Date()),
          (o = l ? n.getTime() - l.getTime() : 0),
          this._serverSyncs.push([i.options.serverSync, o]);
      }
      var _ = i.options.timezone;
      (_ = null == _ ? -n.getTimezoneOffset() : _),
        (s || (!s && null == i._until && null == i._since)) &&
          ...
          (i._until = this.UTCDate(_, this._determineTime(i.options.until, n))),
    ...
    _generateHTML: function (t) {
      ...
      for (
        var p = !1,
          u = 0,
          c = t.options.significant,
          h = e.extend({}, t._show),
          d = i;
        l >= d;
        d++
      )
        (p |= "?" == t._show[d] && t._periods[d] > 0),
          (h[d] = "?" != t._show[d] || p ? t._show[d] : null),
          (u += h[d] ? 1 : 0),
          (c -= t._periods[d] > 0 ? 1 : 0);
      for (var m = [!1, !1, !1, !1, !1, !1, !1], d = l; d >= i; d--)
        t._show[d] && (t._periods[d] ? (m[d] = !0) : ((m[d] = c > 0), c--));
      var g = t.options.compact ? t.options.compactLabels : t.options.labels,
        w = t.options.whichLabels || this._normalLabels,
        f = function (e) {
          var i = t.options["compactLabels" + w(t._periods[e])];
          return h[e]
            ? _._translateDigits(t, t._periods[e]) + (i ? i[e] : g[e]) + " "
            : "";
        },
        D = t.options.padZeroes ? 2 : 1,
        y = function (e) {
          var i = t.options["labels" + w(t._periods[e])];
          return (!t.options.significant && h[e]) ||
            (t.options.significant && m[e])
            ? '<span class="' +
                _._sectionClass +
                '"><span class="' +
                _._amountClass +
                '">' +
                _._minDigits(t, t._periods[e], D) +
                '</span><span class="' +
                _._periodClass +
                '">' +
                (i ? i[e] : g[e]) +
      ...
      return t.options.layout
        ...
        : (t.options.compact
            ? '<span class="' +
              ...
              f(n) +
              f(o) +
              (h[a] ? this._minDigits(t, t._periods[a], 2) : "") +
              (h[r]
                ? (h[a] ? t.options.timeSeparator : "") +
                  this._minDigits(t, t._periods[r], 2)
                : "") +
              (h[l]
                ? (h[a] || h[r] ? t.options.timeSeparator : "") +
                  this._minDigits(t, t._periods[l], 2)
                : "")
            : '<span class="' +
              this._rowClass +
              " " +
              this._showClass +
              (t.options.significant || u) +
              (t._hold ? " " + this._holdingClass : "") +
              '">' +
              y(i) +
              y(s) +
    ...
    _buildLayout: function (t, _, p, u, c, h) {
      for (
        var d = t.options[u ? "compactLabels" : "labels"],
          m = t.options.whichLabels || this._normalLabels,
          g = function (e) {
            return (t.options[
              (u ? "compactLabels" : "labels") + m(t._periods[e])
            ] || d)[e];
          },
          w = function (e, i) {
    ...
    _determineShow: function (e) {
      ...
      return (
        ...
        (_[a] = t.match("h") ? "?" : t.match("H") ? "!" : null),
        (_[r] = t.match("m") ? "?" : t.match("M") ? "!" : null),
    ...
    _calculatePeriods: function (e, t, _, p) {
      ...
      e._since
        ? p.getTime() < e._since.getTime()
          ? (e._now = p = u)
          : (p = e._since)
        : (u.setTime(e._until.getTime()),
          p.getTime() > e._until.getTime() && (e._now = p = u));
      var c = [0, 0, 0, 0, 0, 0, 0];
      if (t[i] || t[s]) {
        var h = this._getDaysInMonth(p.getFullYear(), p.getMonth()),
          ...
          m =
            u.getDate() == p.getDate() ||
            (u.getDate() >= Math.min(h, d) && p.getDate() >= Math.min(h, d)),
          g = function (e) {
          ...
          w = Math.max(
            ...
            12 * (u.getFullYear() - p.getFullYear()) +
              u.getMonth() -
              p.getMonth() +
              ((u.getDate() < p.getDate() && !m) || (m && g(u) < g(p)) ? -1 : 0)
          );
        (c[i] = t[i] ? Math.floor(w / 12) : 0),
          (c[s] = t[s] ? w - 12 * c[i] : 0),
          (p = new Date(p.getTime()));
        var f = p.getDate() == h,
          D = this._getDaysInMonth(p.getFullYear() + c[i], p.getMonth() + c[s]);
        p.getDate() > D && p.setDate(D),
          p.setFullYear(p.getFullYear() + c[i]),
          p.setMonth(p.getMonth() + c[s]),
          f && p.setDate(D);
      }
      ...
      if (
        ...
        for (
          var T = [1, 12, 4.3482, 7, 24, 60, 60], M = l, C = 1, b = l;
          b >= i;
          b--
        )
          t[b] &&
